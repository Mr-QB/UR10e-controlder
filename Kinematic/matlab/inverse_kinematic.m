...
T_01 = transform_T(a_1,alpha_1,d_1,theta_1);
T_12 = transform_T(a_2,alpha_2,d_2,theta_2);
T_23 = transform_T(a_3,alpha_3,d_3,theta_3);
T_34 = transform_T(a_4,alpha_4,d_4,theta_4);
T_45 = transform_T(a_5,alpha_5,d_5,theta_5);
T_56 = transform_T(a_6,alpha_6,d_6,theta_6);
T_06 =  T_01 * T_12 * T_23 * T_34 * T_45 * T_56;


%% calc Pose
Pose_6 = Find_Pose(T_06);P_6 = double(Pose_6)                    %Pose joint 6 of robot.
%% find Thetas of robot
Pose_6 = [0,0,0,0.2511,0.3654,-0.3758]
...
function thetas = Find_thetas(Pose_06)                              %Function find thetas with Pose P06
    ...
    theta4 = double(Find_theta4(T_34));
